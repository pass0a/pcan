...
int Pcan::open(int baudrate, int hwtype, int selectedio, int selectedinterrupt)
{
...
TPCANStatus Pcan::write(TPCANMsg& CANMsg) {
    return CAN_Write(m_PcanHandle, &CANMsg);
}
TPCANStatus Pcan::read(TPCANMsg& CANMsg) {
    TPCANTimestamp CANTimeStamp;
    return CAN_Read(m_PcanHandle, &CANMsg, &CANTimeStamp);
}
